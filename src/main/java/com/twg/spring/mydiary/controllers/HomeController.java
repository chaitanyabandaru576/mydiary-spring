...
public class HomeController {
	...
	@RequestMapping(value="saveuser",method=RequestMethod.POST)//it means it accepts only post requests not get requests
	public ModelAndView saveuser(@ModelAttribute("user") User user) {
		//code to save user details in DB
		
		ModelAndView model=new ModelAndView("registersuccess");
		if(user.getUsername().equals("")) model.setViewName("registrationpage");
